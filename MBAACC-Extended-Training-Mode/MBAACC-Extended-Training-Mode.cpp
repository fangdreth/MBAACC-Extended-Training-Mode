            ...
            while (1)
            {
                ...
                else
                {
                    ...
                    if (bPaused)
                    {
                        ...
                        WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwViewScreenStringAddress), &pcExtendedSettings, 18, 0);
                        ...
                        if (nCurrentSubMenu == eMenu::MAIN)
                        {
                            ...
                            else
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwReturnToMainMenuString), &pcBlank, 19, 0);
                            }
                        }
                        ...
                        if (bOnExtendedSettingsMenu)
                        {
                            ...
                            char pcExtendedSettings[18] = "EXTENDED SETTINGS";
                            char pcBlank[1] = "";
                            WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyActionInfoStringAddress), &pcTrainingPreset, 18, 0);
                            WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemySettingsMenuTitle), &pcExtendedSettings, 18, 0);
                            WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwReduceDamageString), &pcBlank, 1, 0);
                            WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwDefaultString), &pcBlank, 1, 0);
                            if (nExtendedSettingsPage == 1)
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyActionString), &pcReversalType, 14, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseString), &pcExGuard, 9, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseTypeStringAddress), &pcReversalDelay, 15, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwAirRecoveryString), &pcMeter, 18, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwDownRecoveryString), &pcHealth, 19, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwThrowRecoveryString), &pcGuardBar, 10, 0);
                            }
                            else if (nExtendedSettingsPage == 2)
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyActionString), &pcASlow, 12, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseString), &pcP1XLoc, 11, 0);
                                if (bP3Exists)
                                    WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseTypeStringAddress), &pcAssistLoc, 13, 0);
                                else
                                    WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseTypeStringAddress), pcBlank, 2, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwAirRecoveryString), &pcP2XLoc, 11, 0);
                                if (bP4Exists)
                                    WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwDownRecoveryString), &pcAssistLoc, 13, 0);
                                else
                                    WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwDownRecoveryString), pcBlank, 2, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwThrowRecoveryString), &pcUnstable, 11, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwThrowRecoveryNormalString), &pcInvert, 7, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwThrowRecoveryAllFastString), &pcInvert, 7, 0);
                            }
                            else if (nExtendedSettingsPage == 3)
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyActionString), &pcSionBullets, 13, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseString), &pcRoaVisibleCharge, 19, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyDefenseTypeStringAddress), &pcRoaHiddenCharge, 19, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwAirRecoveryString), &pcBlank, 2, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwDownRecoveryString), &pcBlank, 2, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwThrowRecoveryString), &pcHitsUntilBurst, 17, 0);
                            }
                        ...
                        // ENEMEY SETTINGS
                        if (!bOnExtendedSettingsMenu && nCurrentSubMenu == eMenu::BATTLE_SETTINGS)
                        {
                            // enemy action.
                            ...
                            WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwEnemyActionString), &pcEnemyReversal, 15, 0);
                        ...
                        if (nCurrentSubMenu == eMenu::ENEMY_SETTINGS)
                        {
                            ...
                            if (bLifeRecover)
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwNoRecoverString), &pcTemp, 8, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwRecover25String), &pcTemp, 8, 0);
                            ...
                            else
                            {
                                ...
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwRecover75String), &pcTemp, 11, 0);
                                WriteProcessMemory(hMBAAHandle, (LPVOID)(oPointerManager.m_dwRecover100String), &pcTemp, 11, 0);
