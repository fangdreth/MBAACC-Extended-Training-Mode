...
const ADDRESS adP1SubBase = 0x155134; //not used currently, will update soon
...
const ADDRESS adMagicCircuitPause = 0xEE;
...
const ADDRESS adWillBlock = 0x17C;
const ADDRESS adBurstLock = 0x182;
...
const ADDRESS adOnHitCount = 0x1EE;
...
const ADDRESS adStanceDelayed = 0x31B;
